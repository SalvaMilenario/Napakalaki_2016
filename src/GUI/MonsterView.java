...
public class MonsterView extends javax.swing.JPanel {
    ...
    public void setMonster(Monster m) {
        ...
        this.combatLevel.setText("Nivel "+Integer.toString(m.getCombatLevel()));
        this.combatLevelCultist.setText("Nivel S. "+Integer.toString(m.getLevelChangeAgainstCultistPlayer()));
        this.prize.setPrize(monsterModel.getTreasuresGained(), monsterModel.getLevelsGained());
